...
Measures.measuresCollection.eType = MeasuresCombination
...
MeasuresCombination.asset.eType = Asset
MeasuresCombination.costInformation.eType = CostInformation
MeasuresCombination.dataSource.eType = AbstractDataSource
